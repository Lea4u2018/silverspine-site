...
export const STUDIO_LETTER_CATALOG = [
  ...
  { tab: "followUp-arcApplicationReceived", group: "followUp", key: "arcApplicationReceived", label: "Follow-up · ARC Sneak Peek · Oct 1–3", matchRoles: ["arc-applicant"], matchKinds: ["arc"] },
...
export function defaultEmailTemplates() {
  return {
    ...
    selection: {
      arcSelected: {
        ...
        body: [
          ...
          "",
          "WHAT THIS MEANS",
          "• You received the Extended Sneak Peek (Prologue & Chapters 1–2) — not the full novel",
          `• ARC Sneak Peek delivery: ${LAUNCH_MILESTONES.arcDelivery}`,
          "• Official release day (full digital file + hardcover): November 1, 2026",
          "",
    ...
    followUp: {
      ...
      insiderPreorder: {
        subject: "[INSIDER] Gumroad Insider Deal {{insiderStart}} — Silver Spine Studio™",
        body: [
          "Hi {{firstName}},",
          "",
          "Follow-up for readers on the Silver Spine Studio™ list: Gumroad Insider Deal is {{insiderStart}} at {{insiderPrice}} (save {{insiderSave}} vs retail {{retailPrice}}). The full DIGITAL file arrives November 1, 2026 with the hardcover.",
          "",
