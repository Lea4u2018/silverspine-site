...
export const STUDIO_LETTER_CATALOG = [
  { tab: "distribution-sneakPeek", group: "distribution", key: "sneakPeek", label: "File · Sneak peek", category: "file", copyType: "sneakPeek" },
  ...
  { tab: "followUp-arcApplicationReceived", group: "followUp", key: "arcApplicationReceived", label: "Follow-up · ARC application received", matchRoles: ["arc-applicant"], matchKinds: ["arc"] },
    ...
    selection: {
      arcSelected: {
        ...
        body: [
          ...
          "• ARC delivery window: September 21–23, 2026",
    ...
    followUp: {
      arcApplicationReceived: {
        ...
        body: [
          ...
          "",
          "TIMELINE",
          `• Sign-up window: ${LAUNCH_MILESTONES.arcSignups}`,
          `• Selection emails: ${LAUNCH_MILESTONES.arcSelection}`,
          `• If selected, delivery: ${LAUNCH_MILESTONES.arcDelivery}`,
          "",
