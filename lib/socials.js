...
import {
  ...
  FaYoutube,
  FaGlobe,
  FaShoppingCart, // <-- 1. Added the Shopping Cart icon import here
} from "react-icons/fa";
...
export const CORE_ICONS = [
  ...
  {
    key: "threads_live", // <-- Changed the key to force a clean cache bypass!
    label: "Threads",
  ...
  {
    key: "sneaks",
    label: "View Store & Books", // <-- Cleaned up the hover label to match your new route
    href: "/books", // <-- Overwrote your Gumroad string path to route internally!
    icon: FaShoppingCart,
  }
];
