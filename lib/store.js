...
export const PREORDER_STATUS = {
  digitalLive: false,
  headline: `Early-bird digital rate ${NOVEL_PRICING.insider} on Oct 22 · official release Nov 1`,
  detail: `The Extended Sneak Peek (${NOVEL_PRICING.sneakPeek}) is available now and places you on the Insider whitelist. Oct 22 is not the release — it is Gumroad Insider Deal day, when sneak-peek buyers lock in ${NOVEL_PRICING.insider} (save ${NOVEL_PRICING.insiderSavePercent}) for the full DIGITAL novel. You receive that file on official release day, ${NOVEL_PRICING.releaseLabel}, with the hardcover. Digital retail ${NOVEL_PRICING.retail} · paperback ${NOVEL_PRICING.paperback} · hardcover ${NOVEL_PRICING.hardcover} from ${NOVEL_PRICING.releaseLabel}.`,
  digitalTicker: `Early-bird digital ${NOVEL_PRICING.insider} Oct 22 · file on release day Nov 1`,
...
export const SNEAK_PEEK_PRODUCT_COPY = {
  ...
  insiderPerk: `By purchasing this Sneak Peek today for just ${NOVEL_PRICING.sneakPeek}, you place yourself on the Insider whitelist. On Gumroad Insider Deal day (${NOVEL_PRICING.digitalPreorderStartLabel}) you lock in ${NOVEL_PRICING.insider} (save ${NOVEL_PRICING.insiderSavePercent}) instead of retail ${NOVEL_PRICING.retail}. That is a release-day discount — not an early copy of the novel. The full DIGITAL file is delivered ${NOVEL_PRICING.releaseLabel} with the hardcover.`,
...
export const LAUNCH_COUNTDOWN_MATRIX = [
  ...
  { icon: "⚡", when: LAUNCH_MILESTONES.launchWeek, title: "Launch Week Events", note: "Site announcements and socials" },
  {
    ...
    note: `${NOVEL_PRICING.insider} early-bird rate · not the release · file Nov 1`,
  },
  {
    icon: "⚖️",
...
export const LAUNCH_COUNTDOWN_TARGETS = [
  {
    ...
    detail: `${NOVEL_PRICING.insider} early-bird rate · not the release · file Nov 1`,
    href: "/shop",
  },
  {
