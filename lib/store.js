 ...
 * Cover Aug 3 · Sneak Peek Aug 4 (LIVE in stores) · ARC apps Aug 7–14 (25) · Select Aug 17
 * Trailer 2 Aug 21 · ARC Sneak Peek delivery Oct 1–3 (not the full novel)
 * Launch week Oct 21–28 · Gumroad Insider Deal Oct 22
 * Full DIGITAL file + hardcover + paperback Nov 1, 2026
 */
export const NOVEL_PRICING = {
  sneakPeek: "$4.99",
  insider: "$14.99",
  /** Full DIGITAL file + retail on Nov 1. Insider price is Gumroad Oct 22. */
  retail: "$19.99",
  paperback: "$24.99",
  hardcover: "$29.99",
  ...
  /** Gumroad Insider Deal — one day. File still Nov 1. */
  digitalPreorderStartLabel: "Oct 22, 2026",
  digitalPreorderEndLabel: "Oct 22, 2026",
  hardcoverOrderFromLabel: "Nov 1, 2026",
  retailFromLabel: "Nov 1, 2026",
  releaseLabel: "Nov 1, 2026",
  launchWeekLabel: "Oct 21–28, 2026",
  insiderStartLabel: "Oct 22, 2026",
  insiderEndLabel: "Oct 22, 2026",
};

/** Clarifies digital vs hardcover — sneak peek is live now. */
export const PREORDER_STATUS = {
  digitalLive: false,
  headline: "Gumroad Insider Deal Oct 22 · full digital file + hardcover Nov 1",
  detail: `The Extended Sneak Peek (${NOVEL_PRICING.sneakPeek}) is available now in stores and places you on the Insider whitelist. Gumroad Insider Deal is ${NOVEL_PRICING.digitalPreorderStartLabel} at ${NOVEL_PRICING.insider} for whitelisted readers. The full DIGITAL file is not ready until ${NOVEL_PRICING.releaseLabel} — the same day hardcover ${NOVEL_PRICING.hardcover} and paperback ${NOVEL_PRICING.paperback} go live. Digital retail ${NOVEL_PRICING.retail} from ${NOVEL_PRICING.releaseLabel}.`,
  digitalTicker: `Full DIGITAL · Gumroad Insider Oct 22 · file Nov 1 with hardcover · ${NOVEL_PRICING.insider}`,
...
export const LAUNCH_MILESTONES = {
  ...
  digitalPreorder: "Oct 22, 2026",
  insiderWindow: "Oct 22, 2026",
  hardcoverOrders: "Nov 1, 2026",
  /** @deprecated use digitalPreorder */
  preorder: "Oct 22, 2026",
...
export const SNEAK_PEEK_PRODUCT_COPY = {
  ...
  insiderPerk: `By purchasing this Sneak Peek today for just ${NOVEL_PRICING.sneakPeek}, you place yourself on the Insider Deal whitelist — locking in the early full-DIGITAL novel rate of ${NOVEL_PRICING.insider} (save ${NOVEL_PRICING.insiderSavePercent}) on Gumroad Insider Deal day (${NOVEL_PRICING.digitalPreorderStartLabel}), instead of the regular retail price of ${NOVEL_PRICING.retail}. The full DIGITAL file arrives ${NOVEL_PRICING.releaseLabel} with the hardcover.`,
...
export const LAUNCH_COUNTDOWN_MATRIX = [
  { icon: "🎨", when: LAUNCH_MILESTONES.coverReveal, title: "Cover Reveal", note: "live" },
  {
    ...
    note: "Prologue & Chapters 1–2 · live in stores",
  },
  {
    icon: "📅",
    when: LAUNCH_MILESTONES.arcSignups,
    title: "ARC Sign-ups",
    note: `${ARC_TEAM_SIZE} sleuths · Sneak Peek sent · list closed`,
  },
  { icon: "📩", when: LAUNCH_MILESTONES.arcSelection, title: "ARC Selection Emails Sent", note: "Done" },
  { icon: "🎬", when: LAUNCH_MILESTONES.trailer2, title: "Teaser Trailer 2 Drop", note: "Done" },
  {
    icon: "📦",
    when: LAUNCH_MILESTONES.arcDelivery,
    title: "ARC Sneak Peek delivery",
    note: "Done · Prologue & Chapters 1–2 only — not the full novel",
  },
  { icon: "⚡", when: LAUNCH_MILESTONES.launchWeek, title: "Launch Week Events", note: "Site announcements and socials" },
  {
    icon: "🚀",
    when: LAUNCH_MILESTONES.insiderWindow,
    title: "Gumroad Insider Deal",
    note: `${NOVEL_PRICING.insider} for whitelisted readers · full DIGITAL file still Nov 1`,
  },
  {
    icon: "⚖️",
    when: LAUNCH_MILESTONES.release,
    title: "Official Release Day — full digital file & print orders",
...
export const LAUNCH_COUNTDOWN_TARGETS = [
  {
    key: "insiderDay",
    at: "2026-10-22T06:00:00.000Z",
    label: "Gumroad Insider Deal",
    detail: `${NOVEL_PRICING.insider} for whitelisted readers · full file Nov 1 with the hardcover`,
    href: "/shop",
  },
  {
    key: "hardcoverRelease",
    at: "2026-11-01T06:00:00.000Z",
    label: "Official release — full digital file & hardcover",
...
export const SNEAK_PEEK_STORES = [
  ...
  },
  {
    key: "borrowbox",
    label: "BorrowBox",
    shortLabel: "BorrowBox",
    description: "Ask your library · search or suggest it in the BorrowBox app",
    href: null,
    status: "library",
  },
  {
    ...
    label: "Gardners",
    shortLabel: "Gardners",
    description: "UK wholesale · libraries and bookshops order through Gardners",
    href: null,
    status: "library",
  },
  {
