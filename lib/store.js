 ...
 * Trailer 2 Aug 21 · ARC delivery Sep 21–23
 * Digital full novel preorder Sep 30, 2026 @ $14.99 Insider
 * Hardcover orders from Nov 1, 2026 · Launch week Oct 21–28 · Release Nov 1 @ $24.99
 */
...
export const PREORDER_STATUS = {
  ...
  detail:
    "The Extended Sneak Peek ($4.99) is available now and places you on the Insider whitelist. The full DIGITAL copy opens for preorder Sep 30, 2026 at $14.99 for whitelisted readers. Hardcover is not available for order until Nov 1, 2026.",
  digitalTicker: `Full DIGITAL copy · Sep 30 · Insider ${NOVEL_PRICING.insider}`,
  hardcoverTicker: `Hardcover orders · ${NOVEL_PRICING.hardcoverOrderFromLabel}`,
};
...
export const SNEAK_PEEK_PRODUCT_COPY = {
  ...
  hardcoverNote: `Hardback orders go live ${NOVEL_PRICING.hardcoverOrderFromLabel}.`,
  holidayNote:
...
export const LAUNCH_COUNTDOWN_MATRIX = [
  ...
  { icon: "⚡", when: LAUNCH_MILESTONES.launchWeek, title: "Launch Week Events", note: "" },
  {
    ...
    note: `Regular retail ${NOVEL_PRICING.retail}`,
  },
];
...
export const LAUNCH_COUNTDOWN_TARGETS = [
  ...
  },
  {
    ...
    detail: `Regular retail ${NOVEL_PRICING.retail}`,
    href: "/shop",
  },
];
