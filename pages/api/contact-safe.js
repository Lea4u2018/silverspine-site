  ...
  const mailByKind = {
    arc: {
      ...
      customerText: [
        ...
        "• An Advanced Review Copy (ARC) — Extended Sneak Peek (Prologue & Chapters 1–2), not the full novel",
        `• Preferred format on file: ${format || "EPUB or PDF"}`,
        "• This is separate from the paid Extended Sneak Peek available in the Shop",
        "",
        "WHAT HAPPENS NEXT",
        "1) ARC sign-up window: August 7–14, 2026",
        "2) Selection emails go out: August 17, 2026 (25 sleuths)",
        "3) If selected, ARC Sneak Peek delivery: October 1–3, 2026 (Prologue & Chapters 1–2 — not the full novel)",
    ...
    list: {
      ...
      customerText: [
        ...
        "",
        `You’ll get updates on The Beautiful Beast sneak peek news, the Oct 22 Gumroad Insider Deal, and release-day news for ${NOVEL_PRICING.releaseLabel} (full digital file and hardcover).`,
        "",
